...
public class EventServiceImpl implements EventService {
    ...
    public EventFullDto createEvent(Long userId, NewEventDto newEventDto) {
        ...
        LocalDateTime eventDate = LocalDateTime.parse(newEventDto.getEventDate(), dateFormatter);
    ...
    public EventFullDto updateEvent(Long eventId, UpdateEventAdminDto updateEventAdminDto) {
        ...
        if (updateEventAdminDto.getStateAction() != null) {
            if (updateEventAdminDto.getStateAction().equals(StateActionForAdmin.PUBLISH_EVENT)) {
                ...
                event.setPublishedOn(LocalDateTime.now().format(dateFormatter));
        ...
        if (updateEventAdminDto.getEventDate() != null) {
            LocalDateTime eventDateTime = LocalDateTime.parse(updateEventAdminDto.getEventDate(), dateFormatter);
            if (eventDateTime.isBefore(LocalDateTime.now())
                    || eventDateTime.isBefore(LocalDateTime.parse(event.getPublishedOn(), dateFormatter).plusHours(1))) {
    ...
    public EventFullDto updateEventByUser(Long userId, Long eventId, UpdateEventUserDto updateEventUserDto) {
        ...
        if (updateEventUserDto.getEventDate() != null) {
            LocalDateTime eventDateTime = LocalDateTime.parse(updateEventUserDto.getEventDate(), dateFormatter);
    ...
    public void setView(List<Event> events) {
        ...
        String uri = "";
        for (Event event : events) {
            if (start.isBefore(LocalDateTime.parse(event.getCreatedOn(), dateFormatter))) {
                start = LocalDateTime.parse(event.getCreatedOn(), dateFormatter);
            }
    ...
    public void setView(Event event) {
        String startTime = event.getCreatedOn();
        String endTime = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
